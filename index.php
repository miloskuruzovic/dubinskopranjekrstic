...
<nav id="navigation" class="navbar navbar-inverse navbar-fixed-top">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#/"><img id="logo" src="img/logo.png" alt="logo">
      <span style="display: none;">Home page</span></a>
    </div>
...
<footer class="container-fluid text-center">
  <div class="row" id="footer_main">
    <div class="col-sm-4" id="footer_nav">
      <h4>Dubinsko pranje Krstić</h4>
      <br>
      <ul>
        <li><a href="#/">Home</a></li>
        <li><a href="#/cenovnik">Cenovnik</a></li>
    ...
    <div class="col-sm-4" id="footer_social">
      ...
      <p>I budite u toku sa našim vestima i promocijama!</p>
    </div>
  ...
  <div class="row" id="btt">
    <a id="up_link" class="up-arrow" href="#myPage" data-toggle="tooltip" title="Povratak na vrh stranice">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h3 class="modal-title">Miloš Kuruzović</h3>
            <h4>Izrada i održavanje web sajtova</h4>
          </div>
          <div class="modal-body">
            <h4>Izrada unikatnih i modernih web prezentacija, prilagodljivih svim vrstama uređaja (Responsive Web Design).</h4>
            <hr>
            <p class="text-left">
              Kontakt telefon (WhatsApp, Viber): <br><br>
              <i class="fa fa-mobile" aria-hidden="true"></i> 
              <i class="fa fa-whatsapp" aria-hidden="true"></i> 
              &nbsp;<a href="tel:+381641964112">+381 64 1964112</a>
            </p>
            <hr>
            <p class="text-left">
              Email: <br><br>
              <i class="fa fa-envelope-o" aria-hidden="true"></i> &nbsp;
              <a href="mailto:miloskuruzovic@gmail.com">
               miloskuruzovic@gmail.com
              </a>
            </p>
          </div>
